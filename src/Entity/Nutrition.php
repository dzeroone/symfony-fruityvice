...
class Nutrition
{
    ...
    #[ORM\OneToOne(inversedBy: 'nutrition', cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(nullable: false)]
    private ?Fruit $fruit_id = null;
    ...
    public function getFruitId(): ?Fruit
    {
        return $this->fruit_id;
    }

    public function setFruitId(Fruit $fruit_id): self
    {
